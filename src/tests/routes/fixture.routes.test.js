  ...
  describe('POST /api/v1/fixtures', () => {
    describe('Authorized Admin', () => {
      it('should create fixture', async (done) => {
        ...
        expect(res.body.payload.fixture.homeTeam.toString()).toEqual(homeTeam._id.toString())
        done()
      })

      it('should generate new link', async (done) => {
        expect(true).toBe(true)
        done()
      })

      it('should update exisitng fixture', async (done) => {
        expect(true).toBe(true)
        done()
      })
